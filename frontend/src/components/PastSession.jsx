...
const PastSession = () => {
    ...
    if (sessions.length === 0) return (
        <div className="flex flex-col items-center justify-center py-20 gap-4">
            <div className="bg-base-200 rounded-full p-6">
                <CalendarX size={40} className="text-base-content/30" />
            </div>
            <h3 className="text-lg font-semibold text-base-content/50">No Past Sessions</h3>
    ...
    const getStatusBadge = (status) => {
        switch (status) {
            case 'completed':
                return <span className="badge badge-success p-3">Completed</span>;
            case 'cancelled':
                return <span className="badge badge-error p-3">Cancelled</span>;
            default:
                return <span className="badge badge-ghost p-3">{status}</span>;
        }
    };
                        ...
                        <div className="card-body p-4 flex flex-col gap-3">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="avatar placeholder">
                                    <div className="w-12 h-12 rounded-full bg-base-200 text-base-content font-bold text-xl flex items-center justify-center overflow-hidden">
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-sm text-base-content/50">
                                        {otherParticipant?.college} • {otherParticipant?.department}
                                    </p>
